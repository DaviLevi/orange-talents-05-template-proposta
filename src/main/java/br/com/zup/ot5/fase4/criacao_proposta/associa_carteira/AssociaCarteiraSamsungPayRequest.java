...
public class AssociaCarteiraSamsungPayRequest implements AssociaCarteiraRequest{
	...
	@JsonCreator
	public AssociaCarteiraSamsungPayRequest(@Email @NotBlank String email) {
		super();
		this.email = email;
	}
	...
	public Carteira converterParaCarteira(Cartao cartaoAssociado, String id) {
		return new Carteira(id, cartaoAssociado, TipoCarteira.SAMSUNG_PAY, this.email);
	}
}
